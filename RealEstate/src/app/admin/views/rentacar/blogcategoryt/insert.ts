...
export class AdminBlogCategoryTInsertComponent {
	errorMsg: string;
	...
	ngOnInit() {
		...
		this.subscription = this.service.get("BlogCategoryT", "Insert").subscribe((answer: any) => {
			this.model = answer;
	...
	onSubmit() {
		...
		this.service.post("BlogCategoryT", "Insert", this.data)
