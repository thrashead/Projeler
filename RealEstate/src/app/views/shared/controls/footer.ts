...
export class FooterComponent {
    ...
    GetLangContent() {
        ...
        this.service.get("Site", "GetLangContentByCode", "cmn_lst_insert", 1).subscribe((resData: any) => {
        ...
        this.service.get("Site", "GetLangContentByCode", "ftr_feat_forloan", 1).subscribe((resData: any) => {
            this.forloan = resData.ShortDescription;
        }, resError => this.errorMsg = resError);
