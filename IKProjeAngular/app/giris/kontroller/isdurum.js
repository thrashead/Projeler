...
var GirisIsDurumComponent = /** @class */ (function () {
    //rasgeleSiir: [];
    function GirisIsDurumComponent(ikService) {
        this.ikService = ikService;
    }
    GirisIsDurumComponent.prototype.ngOnInit = function () {
        //this.ikService.Data()
        //    .subscribe(data => this.rasgeleSiir = data);
    };
    GirisIsDurumComponent = __decorate([
        core_1.Component({
    ...
    return GirisIsDurumComponent;
}());
exports.GirisIsDurumComponent = GirisIsDurumComponent;
//# sourceMappingURL=isdurum.js.map