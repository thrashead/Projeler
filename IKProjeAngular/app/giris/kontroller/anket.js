...
var GirisAnketComponent = /** @class */ (function () {
    //rasgeleSiir: [];
    function GirisAnketComponent(ikService) {
        this.ikService = ikService;
    }
    GirisAnketComponent.prototype.ngOnInit = function () {
        //this.ikService.Data()
        //    .subscribe(data => this.rasgeleSiir = data);
    };
    GirisAnketComponent = __decorate([
        core_1.Component({
    ...
    return GirisAnketComponent;
}());
exports.GirisAnketComponent = GirisAnketComponent;
