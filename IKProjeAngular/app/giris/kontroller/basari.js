...
var GirisBasariComponent = /** @class */ (function () {
    //rasgeleSiir: [];
    function GirisBasariComponent(ikService) {
        this.ikService = ikService;
    }
    GirisBasariComponent.prototype.ngOnInit = function () {
        //this.ikService.Data()
        //    .subscribe(data => this.rasgeleSiir = data);
    };
    GirisBasariComponent = __decorate([
        core_1.Component({
    ...
    return GirisBasariComponent;
}());
exports.GirisBasariComponent = GirisBasariComponent;
//# sourceMappingURL=basari.js.map