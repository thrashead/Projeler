...
export class IsAramaComponent implements AfterContentInit {
    ...
    constructor(private ikService: IKService, private aramaService: AramaService, private adayService: AdayService) {
    }
