...
var IsAramaComponent = /** @class */ (function () {
    function IsAramaComponent(ikService, aramaService, adayService) {
        this.ikService = ikService;
        this.aramaService = aramaService;
        this.adayService = adayService;
    }
    IsAramaComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    IsAramaComponent.prototype.selectedValControl = function (addList, value) {
        var kontrol = true;
    ...
    IsAramaComponent.prototype.sayac = function (i) {
        return new Array(i);
    };
    IsAramaComponent.prototype.ButtonScroll = function () {
    ...
    IsAramaComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ik_service_1.IKService, arama_service_1.AramaService, aday_service_1.AdayService])
    ], IsAramaComponent);
    return IsAramaComponent;
}());
exports.IsAramaComponent = IsAramaComponent;
