...
var IsSehirComponent = /** @class */ (function () {
    function IsSehirComponent(ikService, aramaService, adayService, route) {
        this.ikService = ikService;
        this.aramaService = aramaService;
        this.adayService = adayService;
        this.route = route;
    }
    IsSehirComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.sehir = params['sehir'];
            if (_this.sehir == undefined) {
                _this.kodlar = [9999, 34];
                _this.haric = true;
                _this.ikService.Sehirler(_this.kodlar, _this.haric)
                    .subscribe(function (data) { return _this.sehirler = data; });
            }
            else {
                _this.aramaService.SehirDon(_this.sehir)
                    .subscribe(function (data) {
                    _this.sehirID = data;
                    _this.kodlar = [_this.sehirID];
                    _this.haric = false;
                    _this.ikService.Sehirler(_this.kodlar, _this.haric)
                        .subscribe(function (data) { return _this.sehirler = data; });
                });
            ...
            _this.ikService.AktifKullanici()
                ...
                _this.aramaService.Calismalar(_this.kodlar, true)
    ...
    IsSehirComponent.prototype.selectedValControl = function (addList, value) {
        var kontrol = true;
    ...
    IsSehirComponent.prototype.sayac = function (i) {
        return new Array(i);
    };
    IsSehirComponent.prototype.ButtonScroll = function () {
    ...
    return IsSehirComponent;
}());
exports.IsSehirComponent = IsSehirComponent;
//# sourceMappingURL=arama.sehir.js.map