...
export class AdminNewsletterIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    NewsletterList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("Newsletter", "Index").subscribe((answer: any) => {
                    this.NewsletterList = answer;
