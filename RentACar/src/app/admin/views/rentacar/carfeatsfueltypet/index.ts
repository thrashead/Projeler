...
export class AdminCarFeatsFuelTypeTIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsFuelTypeTList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsFuelTypeT", "Index").subscribe((answer: any) => {
                    this.CarFeatsFuelTypeTList = answer;
