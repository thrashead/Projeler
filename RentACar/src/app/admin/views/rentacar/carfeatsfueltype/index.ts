...
export class AdminCarFeatsFuelTypeIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsFuelTypeList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsFuelType", "Index").subscribe((answer: any) => {
                    this.CarFeatsFuelTypeList = answer;
