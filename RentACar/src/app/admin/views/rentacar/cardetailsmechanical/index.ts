...
export class AdminCarDetailsMechanicalIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarDetailsMechanicalList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarDetailsMechanical", "Index").subscribe((answer: any) => {
                    this.CarDetailsMechanicalList = answer;
