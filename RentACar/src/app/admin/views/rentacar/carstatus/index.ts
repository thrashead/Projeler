...
export class AdminCarStatusIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarStatusList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarStatus", "Index").subscribe((answer: any) => {
                    this.CarStatusList = answer;
