...
export class AdminBlogCommentsIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    BlogCommentsList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("BlogComments", "Index").subscribe((answer: any) => {
                    this.BlogCommentsList = answer;
