...
export class AdminCarFeatsBodyTypeIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsBodyTypeList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsBodyType", "Index").subscribe((answer: any) => {
                    this.CarFeatsBodyTypeList = answer;
