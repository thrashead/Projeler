...
export class AdminCarFeatsMakeIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsMakeList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsMake", "Index").subscribe((answer: any) => {
                    this.CarFeatsMakeList = answer;
