...
export class AdminCarFeatsModelIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsModelList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsModel", "Index").subscribe((answer: any) => {
                    this.CarFeatsModelList = answer;
