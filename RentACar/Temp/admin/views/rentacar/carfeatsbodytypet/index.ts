...
export class AdminCarFeatsBodyTypeTIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsBodyTypeTList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsBodyTypeT", "Index").subscribe((answer: any) => {
                    this.CarFeatsBodyTypeTList = answer;
