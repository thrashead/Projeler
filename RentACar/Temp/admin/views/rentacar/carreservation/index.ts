...
export class AdminCarReservationIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarReservationList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarReservation", "Index").subscribe((answer: any) => {
                    this.CarReservationList = answer;
