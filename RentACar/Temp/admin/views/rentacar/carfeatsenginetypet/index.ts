...
export class AdminCarFeatsEngineTypeTIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsEngineTypeTList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsEngineTypeT", "Index").subscribe((answer: any) => {
                    this.CarFeatsEngineTypeTList = answer;
