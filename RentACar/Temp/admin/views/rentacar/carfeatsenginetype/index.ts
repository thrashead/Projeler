...
export class AdminCarFeatsEngineTypeIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarFeatsEngineTypeList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarFeatsEngineType", "Index").subscribe((answer: any) => {
                    this.CarFeatsEngineTypeList = answer;
