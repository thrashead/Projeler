...
export class AdminCarDetailsFeaturesIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    CarDetailsFeaturesList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("CarDetailsFeatures", "Index").subscribe((answer: any) => {
                    this.CarDetailsFeaturesList = answer;
