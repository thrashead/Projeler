...
export class AdminCarFeatsDriveTypeTInsertComponent {
	errorMsg: string;
	...
	ngOnInit() {
		...
		this.subscription = this.service.get("CarFeatsDriveTypeT", "Insert").subscribe((answer: any) => {
			this.model = answer;
	...
	onSubmit() {
		...
		this.service.post("CarFeatsDriveTypeT", "Insert", this.data)
