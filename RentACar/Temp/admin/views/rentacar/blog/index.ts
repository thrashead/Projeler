...
export class AdminBlogIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    BlogList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("Blog", "Index").subscribe((answer: any) => {
                    this.BlogList = answer;
