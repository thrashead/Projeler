...
export class AdminTestFormIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    TestFormList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("TestForm", "Index").subscribe((answer: any) => {
                    this.TestFormList = answer;
