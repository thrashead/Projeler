...
export class AdminWorkersIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    WorkersList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("Workers", "Index").subscribe((answer: any) => {
                    this.WorkersList = answer;
