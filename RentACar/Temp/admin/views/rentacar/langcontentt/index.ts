...
export class AdminLangContentTIndexComponent implements OnInit, OnDestroy {
    errorMsg: string;
    LangContentTList: any;
    ...
    FillData(Model: any) {
        this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
            ...
            if (this.callTable == true) {
                this.subscription = this.service.get("LangContentT", "Index").subscribe((answer: any) => {
