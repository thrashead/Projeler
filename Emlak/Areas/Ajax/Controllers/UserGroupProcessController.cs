...
namespace Emlak.Areas.Ajax.Controllers
{
    public class UserGroupProcessController : Controller
    {
        ...
        [HttpPost]
        public JsonResult Insert([System.Web.Http.FromBody] KullaniciGrupIslem kullanici)
        {
        ...
        [HttpPost]
        public JsonResult Update([System.Web.Http.FromBody] KullaniciGrupIslem kullanici)
        {
            if (!curUser.HasRight("Users", "u"))
                return Json(null);
