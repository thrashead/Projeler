...
{
    public class RealEstatesTController : Controller
    {
        ...
        [HttpGet]
        public JsonResult Insert(string realID)
        {
        ...
        [HttpPost]
        public JsonResult Insert([System.Web.Http.FromBody] EmlakDil emlak)
        {
            if (!curUser.HasRight("Website", "i"))
                return Json(null);
        ...
        [HttpPost]
        public JsonResult Update([System.Web.Http.FromBody] EmlakDil emlak)
        {
            if (!curUser.HasRight("Website", "u"))
                return Json(null);
