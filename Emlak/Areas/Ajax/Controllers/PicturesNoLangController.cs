...
{
    public class PicturesNoLangController : Controller
    {
        EmlakSiteEntities entity = new EmlakSiteEntities();

        #region PicturesNoLang
        ...
        public JsonResult List(string pictureName = null, string active = null, int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            try
            {
                var list = entity.PicturesNoLang.ToList();
                ...
                return Json(new { Result = "OK", Records = list.JsonConverter<List<PicturesNoLang>>(), TotalRecordCount = _recordCount });
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Insert(PicturesNoLang record)
        {
            try
            {
                ...
                entity.PicturesNoLang.Add(record);
        ...
        public JsonResult Update(PicturesNoLang record)
        {
            try
            {
                if (record.PictureName.IsNull())
                ...
                var picturesnolang = entity.PicturesNoLang.Find(record.ID);

                picturesnolang.Active = record.Active;
                picturesnolang.PictureName = record.PictureName;
                picturesnolang.Code = record.Code;
                picturesnolang.ShortText = record.ShortText;
                picturesnolang.Description = record.Description;
                picturesnolang.Queue = record.Queue;
        ...
        public JsonResult Delete(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainTypeID == ID && a.MainType == "PicturesNoLang").ToList();
                    ...
                    if (result == true)
                    {
                        assignments = entity.Assignments.Where(a => a.TargetTypeID == ID && a.TargetType == "PicturesNoLang").ToList();
                    ...
                    if (result == true)
                    {
                        var picturesnolang = entity.PicturesNoLang.Where(a => a.ID == ID).ToList();

                        if (picturesnolang.Count > 0)
                        {
                            foreach (var item in picturesnolang)
                            {
                                entity.PicturesNoLang.Remove(item);
        ...
        public JsonResult ListContent()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Content" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteContent(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Content" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult ListGallery()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Gallery" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteGallery(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Gallery" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        #region PicturesNoLang Pictures
        ...
        public JsonResult ListPictures()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Pictures" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeletePictures(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Pictures" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult ListFiles()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Files" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteFiles(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Files" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        #region PicturesNoLang FilesNoLang
        ...
        public JsonResult ListFilesNoLang()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "FilesNoLang" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteFilesNoLang(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "FilesNoLang" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        //        ResultBox rb = TDHelper<Assignments>.Select(new List<Where> { new Where(AssignmentsColumns.MainType, "Rank"), new Where(AssignmentsColumns.TargetType, "PicturesNoLang"), new Where(AssignmentsColumns.TargetTypeID, picID) });
        ...
        //        result = TDHelper<Assignments>.Delete(new List<Where> { new Where(AssignmentsColumns.MainType, "Rank"), new Where(AssignmentsColumns.MainTypeID, ID), new Where(AssignmentsColumns.TargetType, "PicturesNoLang"), new Where(AssignmentsColumns.TargetTypeID, picID) }).Result;
        ...
        public JsonResult ListURLink()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "URLink" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteURLink(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "URLink" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        #region PicturesNoLang URLinkNoLang
        ...
        public JsonResult ListURLinkNoLang()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "URLinkNoLang" && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
        ...
        public JsonResult DeleteURLinkNoLang(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "URLinkNoLang" && a.MainTypeID == ID && a.TargetType == "PicturesNoLang" && a.TargetTypeID == picID).ToList();
