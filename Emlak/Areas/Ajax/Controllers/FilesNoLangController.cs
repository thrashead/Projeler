...
{
    public class FilesNoLangController : Controller
    {
        ...
        public JsonResult List(string fileName = null, string active = null, int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            try
            {
                var list = entity.FilesNoLang.ToList();
                ...
                return Json(new { Result = "OK", Records = list.JsonConverter<List<FilesNoLang>>(), TotalRecordCount = _recordCount });
            }
            catch (Exception ex)
            {
        ...
        public JsonResult Insert(FilesNoLang record)
        {
            try
            {
        ...
        public JsonResult Update(FilesNoLang record)
        {
            try
            {
                if (record.FileName.IsNull())
                ...
                var filesnolang = entity.FilesNoLang.Find(record.ID);

                filesnolang.Active = record.Active;
                filesnolang.FileName = record.FileName;
                filesnolang.ShortText = record.ShortText;
                filesnolang.Description = record.Description;
                filesnolang.Code = record.Code;
                filesnolang.Queue = record.Queue;
        ...
        public JsonResult Delete(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainTypeID == ID && a.MainType == "FilesNoLang").ToList();
                    ...
                    if (result == true)
                    {
                        assignments = entity.Assignments.Where(a => a.TargetTypeID == ID && a.TargetType == "FilesNoLang").ToList();
                    ...
                    if (result == true)
                    {
                        var filesnolang = entity.FilesNoLang.Where(a => a.ID == ID).ToList();

                        entity.FilesNoLang.RemoveRange(filesnolang);
        ...
        public JsonResult ListContent()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Content" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeleteContent(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Content" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult ListGallery()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Gallery" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeleteGallery(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Gallery" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult ListPictures()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Pictures" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeletePictures(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Pictures" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        #region FilesNoLang PicturesNoLang
        ...
        public JsonResult ListPicturesNoLang()
        {
            try
            {
                ...
                List<PicturesNoLang> contList = new List<PicturesNoLang>();

                List<PicturesNoLang> list = new List<PicturesNoLang>();

                var assignments = entity.Assignments.Where(a => a.MainType == "PicturesNoLang" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeletePicturesNoLang(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "PicturesNoLang" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult ListFiles()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "Files" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeleteFiles(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "Files" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        //        ResultBox rb = TDHelper<Assignments>.Select(new List<Where> { new Where(AssignmentsColumns.MainType, "Rank"), new Where(AssignmentsColumns.TargetType, "FilesNoLang"), new Where(AssignmentsColumns.TargetTypeID, fileID) });
        ...
        //        result = TDHelper<Assignments>.Delete(new List<Where> { new Where(AssignmentsColumns.MainType, "Rank"), new Where(AssignmentsColumns.MainTypeID, ID), new Where(AssignmentsColumns.TargetType, "FilesNoLang"), new Where(AssignmentsColumns.TargetTypeID, fileID) }).Result;
        ...
        public JsonResult ListURLink()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "URLink" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeleteURLink(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "URLink" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        #region FilesNoLang URLinkNoLang
        ...
        public JsonResult ListURLinkNoLang()
        {
            try
            {
                ...
                var assignments = entity.Assignments.Where(a => a.MainType == "URLinkNoLang" && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
        ...
        public JsonResult DeleteURLinkNoLang(int? ID)
        {
            try
            {
                if (ID != null)
                {
                    ...
                    var assignments = entity.Assignments.Where(a => a.MainType == "URLinkNoLang" && a.MainTypeID == ID && a.TargetType == "FilesNoLang" && a.TargetTypeID == fileID).ToList();
