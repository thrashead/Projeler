...
namespace Emlak.Areas.Ajax.Controllers
{
    public class KullaniciGrupTabloController : Controller
    {
        ...
        [HttpPost]
        public JsonResult Ekle([System.Web.Http.FromBody] KullaniciGrupTablo kullanici)
        {
            if (!curUser.HasRight("Kullanicilar", "i"))
                return Json(null);
        ...
        [HttpPost]
        public JsonResult Duzenle([System.Web.Http.FromBody] KullaniciGrupTablo kullanici)
        {
            if (!curUser.HasRight("Kullanicilar", "u"))
                return Json(null);
