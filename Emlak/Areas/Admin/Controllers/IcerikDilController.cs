...
namespace Emlak.Areas.Admin.Controllers
{
    public class IcerikDilController : Controller
    {
        ...
        public ActionResult Ekle(string contID)
        {
            ...
            List<Data.Content> tableContent = _entity.Content.ToList();
        ...
        public ActionResult Ekle(IcerikDil icerik)
        {
            ...
            if (ModelState.IsValid && icerik.ContID > 0)
            {
                ...
                if (result != null)
                {
                    ...
                    icerik.Mesaj = "Kayýt eklenemedi veya ayný dilde zaten kayýt eklenmiþ.";
            }
            else
        ...
        public ActionResult Duzenle(IcerikDil icerik)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result != null)
                {
                    ...
                    icerik.Mesaj = "Kayýt düzenlenemedi veya ayný dilde zaten kayýt eklenmiþ.";
            }
            else
                icerik.Mesaj = "Model uygun deðil.";
