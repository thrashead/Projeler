...
export class AdminGaleriDuzenleComponent {
    errorMsg: string;
    id: string;
    ...
    constructor(private service: GaleriService, private serviceGalleryT: GaleriDilService, private sharedService: SharedService, private route: ActivatedRoute, private router: Router, private formBuilder: FormBuilder) {
    }
    ...
    onGalleryTDelete(id) {
        this.serviceGalleryT.getSil(id).subscribe((resData) => {
            if (resData == true) {
    ...
    onGalleryTRealDelete(id) {
        this.serviceGalleryT.getKaldir(id).subscribe((resData) => {
            if (resData == true) {
