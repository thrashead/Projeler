...
export class AdminDilIcerikDilEkleComponent {
	errorMsg: string;
	...
	ngOnInit() {
        ...
        this.subscription = this.service.get("DilIcerikDil", "Ekle").subscribe((answer: any) => {
			this.model = answer;
	...
	onSubmit() {
        ...
        this.service.post("DilIcerikDil", "Ekle", this.data)
