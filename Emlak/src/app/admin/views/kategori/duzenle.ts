...
export class AdminKategoriDuzenleComponent {
    errorMsg: string;
    id: string;
    ...
    constructor(private service: KategoriService, private serviceCategoryT: KategoriDilService, private sharedService: SharedService, private route: ActivatedRoute, private router: Router, private formBuilder: FormBuilder) {
    }
    ...
    onCategoryTDelete(id) {
        this.serviceCategoryT.getSil(id).subscribe((resData) => {
            if (resData == true) {
    ...
    onCategoryTRealDelete(id) {
        this.serviceCategoryT.getKaldir(id).subscribe((resData) => {
            if (resData == true) {
