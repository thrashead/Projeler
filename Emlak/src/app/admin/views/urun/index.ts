...
export class AdminUrunIndexComponent {
    errorMsg: string;
    UrunList: {};
    ...
    constructor(private service: UrunService, private sharedService: SharedService, private router: Router) {
    }
