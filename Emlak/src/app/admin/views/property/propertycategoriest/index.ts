...
export class AdminPropertyCategoriesTIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	PropertyCategoriesTList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyCategoriesT", "Index").subscribe((answer: any) => {
				    this.PropertyCategoriesTList = answer;
