...
export class AdminPropertyStatusIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyStatus", "Index").subscribe((answer: any) => {
				    this.PropertyStatusList = answer;
