...
export class AdminPropertyCategoriesIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	PropertyCategoriesList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyCategories", "Index").subscribe((answer: any) => {
				    this.PropertyCategoriesList = answer;
