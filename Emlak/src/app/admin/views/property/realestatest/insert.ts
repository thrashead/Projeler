...
export class AdminRealEstatesTInsertComponent {
    errorMsg: string;
    linkID: string;
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            ...
            this.service.get("RealEstatesT", "Insert", this.linkID).subscribe((resData: any) => {
                this.model = resData;
    ...
    onSubmit() {
        ...
        this.service.post("RealEstatesT", "Insert", this.data)
