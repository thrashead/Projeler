...
export class AdminPropertyDetailsIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyDetails", "Index").subscribe((answer: any) => {
				    this.PropertyDetailsList = answer;
