...
export class AdminWarmTypeTIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	WarmTypeTList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("WarmTypeT", "Index").subscribe((answer: any) => {
				    this.WarmTypeTList = answer;
