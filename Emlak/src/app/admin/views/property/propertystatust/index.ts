...
export class AdminPropertyStatusTIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	PropertyStatusTList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyStatusT", "Index").subscribe((answer: any) => {
				    this.PropertyStatusTList = answer;
