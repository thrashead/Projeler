...
export class AdminPropertyFeaturesIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyFeatures", "Index").subscribe((answer: any) => {
				    this.PropertyFeaturesList = answer;
