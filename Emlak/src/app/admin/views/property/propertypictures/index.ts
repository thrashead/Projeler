...
export class AdminPropertyPicturesIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	PropertyPicturesList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("PropertyPictures", "Index").subscribe((answer: any) => {
				    this.PropertyPicturesList = answer;
