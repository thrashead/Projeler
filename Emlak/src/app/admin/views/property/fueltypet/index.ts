...
export class AdminFuelTypeTIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	FuelTypeTList: any;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
		    ...
		    if (this.callTable == true) {
			    this.subscription = this.service.get("FuelTypeT", "Index").subscribe((answer: any) => {
				    this.FuelTypeTList = answer;
