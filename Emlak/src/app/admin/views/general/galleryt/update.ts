...
export class AdminGalleryTUpdateComponent implements AfterViewChecked {
    errorMsg: string;
    id: string;
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            this.id = params['id'];
            this.service.get("GalleryT", "Update", this.id).subscribe((resData: any) => {
                this.model = resData;
    ...
    onSubmit() {
        ...
        this.service.post("GalleryT", "Update", this.data)
