...
export class AdminUsersGrupDegistirComponent {
    errorMsg: string;
    id: string;
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            this.id = params['id'];
            this.service.get("Users", "GrupDegistir", this.id).subscribe((resData: any) => {
                this.model = resData;
    ...
    onSubmit() {
        ...
        this.service.post("Users", "GrupDegistir", this.data)
