...
export class AdminPictureUpdateComponent {
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            this.id = params['id'];
            this.service.get("Picture", "Update", this.id).subscribe((resData: any) => {
                this.model = resData;
    ...
    onSubmit() {
        ...
        this.service.post("Picture", "DuzenleYukle", this.uploadData)
            .subscribe((answer: any) => {
                if (answer.Mesaj == null) {
                    ...
                    this.service.post("Picture", "Update", this.data)
