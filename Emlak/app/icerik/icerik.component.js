...
var IcerikComponent = /** @class */ (function () {
    ...
    IcerikComponent = __decorate([
        core_1.Component({
            templateUrl: 'app/icerik/icerik.component.html',
            providers: [emlak_service_1.EmlakService]
        }),
        __metadata("design:paramtypes", [emlak_service_1.EmlakService, router_1.ActivatedRoute])
    ], IcerikComponent);
    return IcerikComponent;
}());
exports.IcerikComponent = IcerikComponent;
//# sourceMappingURL=icerik.component.js.map