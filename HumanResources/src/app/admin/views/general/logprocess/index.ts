...
export class AdminLogProcessIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
			...
			if (this.callTable == true) {
				this.subscription = this.service.get("LogProcess", "Index").subscribe((resData: any) => {
					this.LogProcessList = resData;
