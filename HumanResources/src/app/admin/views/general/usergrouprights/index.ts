...
export class AdminUserGroupRightsIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
			...
			if (this.callTable == true) {
				this.subscription = this.service.get("UserGroupRights", "Index").subscribe((resData: any) => {
					this.UserGroupRightsList = resData;
