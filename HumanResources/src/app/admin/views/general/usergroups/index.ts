...
export class AdminUserGroupsIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
			...
			if (this.callTable == true) {
				this.subscription = this.service.get("UserGroups", "Index").subscribe((resData: any) => {
					this.UserGroupsList = resData;
