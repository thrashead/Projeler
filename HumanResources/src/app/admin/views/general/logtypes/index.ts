...
export class AdminLogTypesIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
			...
			if (this.callTable == true) {
				this.subscription = this.service.get("LogTypes", "Index").subscribe((resData: any) => {
					this.LogTypesList = resData;
