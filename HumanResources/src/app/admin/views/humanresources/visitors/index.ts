...
export class AdminVisitorsIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	...
	FillData(Model: any) {
		this.sharedService.getCurrentUserRights(Model).subscribe((userRights: any) => {
			...
			if (this.callTable == true) {
				this.subscription = this.service.get("Visitors", "Index").subscribe((resData: any) => {
					this.VisitorsList = resData;
