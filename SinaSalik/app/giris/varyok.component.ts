...
export class VarYok {
    static dizi: number[] = [];
    static secilenKutu: number = 0;
    static sayac: number = 0;
    static teklif: number = 0;
    ...
    static TeklifVer(sayac: number): boolean {
        var adet = 1;
        var toplam = 0;
    ...
    static KutuDegistir(kutu: string) {
