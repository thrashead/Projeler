...
export class AdminProductTInsertComponent {
    errorMsg: string;
    linkID: string;
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            ...
            this.service.get("ProductT", "Insert", this.linkID).subscribe((resData: any) => {
                this.model = resData;
    ...
    onSubmit() {
        ...
        this.service.post("ProductT", "Insert", this.data)
