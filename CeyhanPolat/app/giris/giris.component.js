...
var GirisComponent = /** @class */ (function () {
    function GirisComponent(_cpService) {
        this._cpService = _cpService;
    }
    GirisComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._cpService.getRasgeleSiir()
            .subscribe(function (resRasgeleSiirData) { return _this.rasgeleSiir = resRasgeleSiirData; }, function (resError) { return _this.errorMsg = resError; });
        this._cpService.getKisaBiyografi()
            .subscribe(function (resKisaBiyografiData) { return _this.kisaBiyografi = resKisaBiyografiData; }, function (resError) { return _this.errorMsg = resError; });
    };
...
//# sourceMappingURL=giris.component.js.map